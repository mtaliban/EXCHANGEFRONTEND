  ...
  return (
    <div className="p-4 md:p-6">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-bold text-brand-grey-900">Mazungumzo</h1>
        <span className="badge-gold">{convs.length} conversations</span>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-soft border border-brand-grey-100 overflow-hidden">
        {convs.map((c) => (
          <Link key={c.conversation_id} href={`/chats/${c.with_user_id}`} className="flex items-center gap-3 p-3 border-b border-brand-grey-100 last:border-0 hover:bg-brand-grey-50 transition">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className={`text-sm truncate ${c.unread > 0 ? 'text-brand-grey-900 font-medium' : 'text-brand-grey-500'}`}>
