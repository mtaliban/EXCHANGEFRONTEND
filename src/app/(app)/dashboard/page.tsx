...
export default function DashboardPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      {/* ═══ WHATSAPP GROUP — official, inaonekana, ya kisomi ═══ */}
      <a
        href={WA_GROUP_LINK}
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-24 right-4 z-50 flex items-center gap-2 rounded-full bg-[#25D366] text-white shadow-2xl hover:shadow-[0_0_20px_rgba(37,211,102,0.5)] transition-all duration-200 pl-3 pr-4 py-2.5 active:scale-95 border border-white/30"
      ...
      >
        ...
        <span className="text-[13px] font-bold whitespace-nowrap">Jiunge na Group</span>
      </a>
    </div>
  );
}
