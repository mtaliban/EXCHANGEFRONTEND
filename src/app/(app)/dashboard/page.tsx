...
export default function DashboardPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      {/* ═══ WHATSAPP GROUP — official, ndogo, ya WhatsApp halisi ═══ */}
      <a
        href={WA_GROUP_LINK}
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-5 right-5 z-40 w-12 h-12 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] text-white shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center active:scale-95"
