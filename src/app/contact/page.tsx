  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-10">
        <span className="badge-gold mb-3">Wasiliana Nasi</span>
        <h1 className="text-4xl font-bold text-brand-grey-900">Tuko Karibu Nawe</h1>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="card">
          ...
          <h3 className="font-bold text-brand-grey-900 mb-1">Simu</h3>
        ...
        <div className="card">
          ...
          <h3 className="font-bold text-brand-grey-900 mb-1">WhatsApp</h3>
        ...
        <div className="card">
          ...
          <h3 className="font-bold text-brand-grey-900 mb-1">Barua Pepe</h3>
        ...
        <div className="card">
          ...
          <h3 className="font-bold text-brand-grey-900 mb-1">Ofisi</h3>
