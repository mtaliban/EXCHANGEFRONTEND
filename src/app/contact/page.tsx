  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="card">
          <div className="w-12 h-12 rounded-xl bg-brand-blue-50 text-brand-blue flex items-center justify-center text-2xl mb-4">📞</div>
        ...
        <div className="card">
          ...
          <a href="https://wa.me/255625607088" className="text-brand-blue hover:underline">+255 625 607 088</a>
        </div>
        <div className="card">
          <div className="w-12 h-12 rounded-xl bg-brand-blue-50 text-brand-blue flex items-center justify-center text-2xl mb-4">📧</div>
