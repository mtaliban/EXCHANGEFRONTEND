  ...
  useEffect(() => {
    ...
    getDepartments(true)
      .then((list) => {
        ...
        // hii ilifanya idara MPYA ya admin isionekane kwenye usajili hadi
        // kada iongezwe. Sasa idara isiyo na kada inaonyesha ujumbe mzuri
        // kwenye hatua ya Kada ("rudi nyuma"), mtumiaji hakwami.
